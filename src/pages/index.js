...
import StarVideo from "../images/star.mp4";
    ...
    return (
        <Layout>
            ...
            <div className="bg-gradient-to-b from-blue-300 to-blue-100 p-4 w-full relative flex items-center justify-center">
                ...
                <Link
                    to="/"
                    className="p-3 bg-gradient-to-tr from-yellow-500/90 to-yellow-600 font-bold text-white text-sm tracking-wide rounded-lg"
                >
                    Wybierz Premium
                </Link>
            </div>
                ...
                <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    ...
                    <div className="flex flex-wrap items-center justify-center space-x-6">
                        {data.allDatoCmsProjekty.edges.map(({ node }) => (
                            <div className="mb-4">
                                <Link to={node.slug}>
                                    <div className="group relative mb-4 block w-auto overflow-hidden rounded-lg lg:mb-5">
                                        <GatsbyImage
